...
class _$LoginImpl implements _Login {
  const _$LoginImpl({required this.requestModel});
...
abstract class _Login implements LoginEvent {
  const factory _Login({required final AuthRequestModel requestModel}) =
      _$LoginImpl;
...
abstract class _Loaded implements LoginState {
  const factory _Loaded({required final AuthResponseModel data}) = _$LoadedImpl;
