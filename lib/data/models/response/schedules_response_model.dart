...
class SchedulesResponseModel {
  ...
  factory SchedulesResponseModel.fromJson(String str) =>
      SchedulesResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory SchedulesResponseModel.fromMap(Map<String, dynamic> json) =>
      SchedulesResponseModel(
